...
public class ProfesorController {
	...
	private ProfesorService profesorService;
        ...
        @ApiOperation("Metodo para listar todos los profesores")
	@GetMapping()
	public ResponseEntity<ResponseDto> readAllProfesor(){
        ...
        @ApiOperation("Metodo para listar un profesor por su id")
	@GetMapping("/{id}")
	public ResponseEntity<ResponseDto> readProfesor(@PathVariable("id")Long id){
        ...
        @ApiOperation("Metodo para añadir un profesor")
	@PostMapping
	public ResponseEntity<ResponseDto> createProfesor(@RequestBody ProfesorDto profesor){
        ...
        @ApiOperation("Metodo para actualizar un profesor")
	@PutMapping
	public ResponseEntity<ResponseDto> updateProfesor(@RequestBody ProfesorDto profesor){
        ...
        @ApiOperation("Metodo para eliminar un profesor (solo cambia el estado a false)")
	@DeleteMapping("/{id}")
